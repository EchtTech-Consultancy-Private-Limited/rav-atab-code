...
class SummaryController extends Controller
{
    ...
    public function isAnyNRPendingAdminSide($application_id,$application_courses_id)
    {
        ...
        foreach ($results as $result) {
            if (($result->status==4 || $result->status==5) && $result->admin_nc_flag==0) {
                $flag = 1;
                break;
            } 
        }
