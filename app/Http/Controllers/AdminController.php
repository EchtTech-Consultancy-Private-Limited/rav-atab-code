...
//Admin user crud
    ...
    public function aduser_post(Request $request)
    {
        ...
        {
        return redirect('/training-provider')->with('success', 'User Add Successfully!!');
        }
        elseif($request->role = '3')
        {
        return redirect('/assessor-user')->with('success', 'User Add Successfully!!');
        }
        elseif($request->role = '5')
        {
        return redirect('/secrete-user')->with('success', 'User Add Successfully!!');
        }
