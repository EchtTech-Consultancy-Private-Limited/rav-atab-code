                                                                ...
                                                                <tr class="<?php if(isset($doc_id1->doc_file)): ?> highlight   <?php if(get_doc_code($doc_id1->id)==__('arrayfile.document_doc_id_chap1')[1] && get_doccomment_status($doc_id1->id)==1): ?> highlight_nc_approved <?php elseif(get_doc_code($doc_id1->id)==__('arrayfile.document_doc_id_chap1')[1] && get_doccomment_status($doc_id1->id)==0): ?> highlight_nc <?php endif; ?> <?php endif; ?>">
                                                                   ...
                                                                   <?php if(isset($doc_id1->doc_file)): ?>
                                                                    <td>
                                                                        ...
                                                                        <a target="_blank" href="<?php echo e(url('view-doc'.'/'.__('arrayfile.document_doc_id_chap1')[1].'/'.$doc_id1->doc_file.'/'.$doc_id1->id)); ?>"
...
<?php /**PATH /home/stagtbny/accr-rav.staggings.in/resources/views/asesrar/view_document.blade.php ENDPATH**/ ?>