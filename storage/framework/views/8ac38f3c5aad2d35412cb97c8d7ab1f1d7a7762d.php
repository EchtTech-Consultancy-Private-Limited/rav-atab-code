            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <form action="<?php echo e(url('update-faq'.'/'.$data->id)); ?>" method="post">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                            <label><strong>FAQ in Details</strong></label>
                                        <div class="form-line">
                                            <textarea class="form-control" name="description" id="description"  placeholder="Ender FAQ Information"><?php echo e($data->description); ?></textarea>
...
<?php /**PATH /home/stagtbny/accr-rav.staggings.in/resources/views/pages/faq-update.blade.php ENDPATH**/ ?>