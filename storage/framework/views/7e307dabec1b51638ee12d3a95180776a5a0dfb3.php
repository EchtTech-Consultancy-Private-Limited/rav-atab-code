                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="card project_widget">
                                          ...
                                          <?php if(isset($check_admin)): ?>
                                          <div class="header">
                                             <h2 class="text-center">CHAPTER 1- (VMO) VISION MISSION AND OBJECTIVES </h2>
                                             <a href="<?php echo e(url('document-report-by-admin/'.$course_id)); ?>" class="btn btn-primary">Update Document Status</a>
                                          </div>
...
<!-- 
                                                        <?php $__currentLoopData = $file; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=> $files): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr class="odd gradeX">
                                                              ...
                                                              <!--   <h1><?php echo e($doc_id1->id); ?></h1> -->

  <tr class="<?php if(isset($doc_id1->doc_file)): ?> highlight   <?php if(get_doc_code($doc_id1->id)==__('arrayfile.document_doc_id_chap1')[1] && get_doccomment_status($doc_id1->id)==1): ?> highlight_nc_approved <?php elseif(get_doc_code($doc_id1->id)==__('arrayfile.document_doc_id_chap1')[1] && get_doccomment_status($doc_id1->id)==3): ?> highlight_nc <?php endif; ?> <?php endif; ?>">
                                                                    <td>VMO.1</td>
 ...
 <a target="_blank" href="<?php echo e(url('admin-view-doc'.'/'.__('arrayfile.document_doc_id_chap1')[1].'/'.$doc_id1->doc_file.'/'.$doc_id1->id.'/'.$course_id)); ?>"
...
<?php /**PATH D:\xampp\htdocs\atab\resources\views/asesrar/admin_view_document.blade.php ENDPATH**/ ?>