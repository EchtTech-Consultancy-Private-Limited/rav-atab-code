...
button#modal-btn-delete, #modal-btn-edit {
    margin-right: 15px;
}
                     ...
                     <div class="modal fade" id="schedule-edit">
                        <div class="modal-dialog">
                           <div class="modal-content">
                              <!-- Modal Header -->
                              <div class="modal-header">
                                 <h4 class="modal-title">Edit Your Schedule</h4><hr>
  ...
  <script>
    $(document).ready(function() {
      ...
      var calendar = $('#schedule-calendar').fullCalendar({
        editable: true,
        events: SITEURL + "/assessor-onsite-assessment-page",
            ...
            if (deleteMsg) {
              ...
              $.ajax({
                ...
                success: function(response) {
                  ...
                  window.location.href = "<?php echo e(url('/assessor-onsite-assessment-page')); ?>";
                }
              });
...
<?php /**PATH /home/stagtbny/accr-rav.staggings.in/resources/views/asesrar/fullcalenderonsite.blade.php ENDPATH**/ ?>