                                ...
                                <?php endif; ?>
                                 ...
                                 <form action="<?php echo e(route('forget.password.post')); ?>" method="POST">
                                     ...
                                     <div class="form-group">
                                         <input type="text" id="email_address" class="form-control" value="<?php echo e(old('email')); ?>" placeholder="Enter your Email ID!!"
                                             <?php echo e(old('email')); ?> name="email" required autofocus>
...
unset($__errorArgs, $__bag); ?>
                                     ...
                                     <div class="form-group clearfix">
                                         ...
                                         <!-- <a href="<?php echo e(url('/')); ?>" class="forgot-password float-end link-text">Back to Login</a> -->
                                     </div>
                                 </form>
...
<?php /**PATH /home/stagtbny/accr-rav.staggings.in/resources/views/auth/forgetPassword.blade.php ENDPATH**/ ?>