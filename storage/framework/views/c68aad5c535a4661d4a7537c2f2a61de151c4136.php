...
.fa-india{
    background-image: url("<?php echo e(asset('assets/images/fa-india.png')); ?>")!important;
...
">
    ...
    <div>
        ...
        <?php echo $__env->make('layout.secretariat', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php elseif(Auth::user()->role == 1 || Auth::user()->role == 2): ?>
                            ...
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <div class="col-4 text-left">
                                        ...
                                        <?php echo e($applications['approved']['india']); ?>
                                ...
                                <div class="col-4 text-left">
                                    ...
                                    <?php echo e(($applications['pending']['india']+$applications['processing']['india'])); ?>
                            ...
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <div class="col-4 text-left"   style="cursor:pointer; z-index:1000!important;"  data-bs-toggle="modal" data-bs-target="#international-active-model">
                                        <span class="span-width">Active</span>
                                        <h2 class="d-flex align-items-left mb-0">
                                        <?php echo e(($applications['approved']['world']+$applications['approved']['saarc'])); ?>
                                ...
                                <div class="col-4 text-left"  style="cursor:pointer; z-index:1000!important;"  data-bs-toggle="modal" data-bs-target="#international-pending-model">
                                    <span class="span-width">Pending</span>
                                    <h2 class="d-flex align-items-right mb-0 mergin-left">
                                    <?php echo e(($applications['pending']['world']+$applications['processing']['world']+$applications['pending']['saarc']+$applications['processing']['saarc'])); ?>
            ...
            <div class="modal-dialog  modal-dialog-centered" role="document" >
                ...
                <div class="card-icon card-icon-large"><i class="fas fa-globe"></i></div>
                    ...
                    <div style="float:left; clear:none; width:50%; position:relative;">
                        ...
                        <div style="font-weight:bold;  font-size:20px;" class="text-white"><?php echo e($applications['approved']['saarc']); ?></div>
                        </div>
                        <div style="float:left; clear:none  width:50%;  position:relative;">
                        <div class="text-white">Rest of The World</div>
                        <div class="text-white" style="font-weight:bold;  font-size:20px;"><?php echo e($applications['approved']['world']); ?></div>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="international-pending-model" tabindex="-1" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
           ...
           <div class="info-box-5">
             <div class="card-icon card-icon-large"><i class="fas fa-globe"></i></div>
                    ...
                    <div style="float:left; clear:none; width:50%; position:relative;">
                        <div class="text-white">SAARC</div>
                        <div class="text-white" style="font-weight:bold;  font-size:20px;"><?php echo e($applications['pending']['saarc']); ?></div>
                        </div>
                        <div style="float:left; clear:none  width:50%;  position:relative;">
                        <div class="text-white">Rest of The World</div>
                        <div class="text-white" style="font-weight:bold;  font-size:20px;"><?php echo e($applications['pending']['world']); ?></div>
                        </div>
                    </div>
...
<script src="<?php echo e(asset('assets/js/charts/highcharts.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/charts/highcharts-3d.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/charts/exporting.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/charts/export-data.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/charts/accessibility.js')); ?>"></script>
...
Highcharts.chart('container', {
    ...
    subtitle: {
        text: 'Total Pending Applications: <?php echo e(($applications['pending']['india']+$applications['pending']['saarc']+$applications['pending']['world'])); ?>',
        align: 'left'
    },
    plotOptions: {
        pie: {
    ...
    series: [{
        ...
        data: [
            ['India', <?php echo e($applications['pending']['india']); ?>],
            ['SAARC',  <?php echo e($applications['pending']['saarc']); ?>],
            ['Rest of the World',  <?php echo e($applications['pending']['world']); ?>],
...
Highcharts.chart('container2', {
    ...
    subtitle: {
        text: 'Total Processing Applications: <?php echo e(($applications['processing']['india']+$applications['processing']['saarc']+$applications['processing']['world'])); ?>',
        align: 'left'
    },
    plotOptions: {
        pie: {
    ...
    series: [{
        ...
        data: [
            ['India', <?php echo e($applications['processing']['india']); ?>],
            ['SAARC',  <?php echo e($applications['processing']['saarc']); ?>],
            ['Rest of the World',  <?php echo e($applications['processing']['world']); ?>],
...
Highcharts.chart('container3', {
    ...
    subtitle: {
        text: 'Total Approved Applications: <?php echo e(($applications['approved']['india']+$applications['approved']['saarc']+$applications['approved']['world'])); ?>',
        align: 'left'
    },
    plotOptions: {
        pie: {
   ...
   /* series: [{
    ...
    series: [{
        ...
        data: [
            ['India', <?php echo e($applications['approved']['india']); ?>],
            ['SAARC',  <?php echo e($applications['approved']['saarc']); ?>],
            ['Rest of the World',  <?php echo e($applications['approved']['world']); ?>],
...
function showHtmlMessageActive() {
    swal({
        ...
        text: '<div style="float:left; clear:none; width:50%; position:relative;">'
            +'<div>SAARC</div>'
            +'<div style="font-weight:bold;  font-size:20px;"><?php echo e($applications['approved']['saarc']); ?></div>'
            +'</div>'
            +'<div style="float:left; clear:none  width:50%;  position:relative;">'
            +'<div>Rest of The World</div>'
            +'<div style="font-weight:bold;  font-size:20px;"><?php echo e($applications['approved']['world']); ?></div>'
            +'</div>',
        html: true,
       timer: 2000,
...
function showHtmlMessagePending() {
   ...
   swal({
        ...
        text: '<div style="float:left; clear:none; width:50%; position:relative;">'
            +'<div>SAARC</div>'
            +'<div style="font-weight:bold;  font-size:20px;"><?php echo e($applications['pending']['saarc']); ?></div>'
            +'</div>'
            +'<div style="float:left; clear:none  width:50%;  position:relative;">'
            +'<div>Rest of The World</div>'
            +'<div style="font-weight:bold;  font-size:20px;"><?php echo e($applications['pending']['world']); ?></div>'
            +'</div>',
        html: true,
        timer: 2000,
       showConfirmButton: false
...
<?php /**PATH E:\xampp\htdocs\atab\resources\views/pages/dashboard.blade.php ENDPATH**/ ?>