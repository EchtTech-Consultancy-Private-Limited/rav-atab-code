        ...
        <div class="container">
            <div class="row login-box">
                ...
                <div class="col-lg-6 align-self-center pad-0 form-info">
                  ...
                  <?php elseif(request()->path() == 'login/secretariat'): ?>
...
unset($__errorArgs, $__bag); ?></label>
                                ...
                                <?php elseif(request()->path() == 'login/secretariat'): ?>
                                <input type="hidden" placeholder="role" name="role" value="<?php echo e(5); ?>">
                                <?php endif; ?>
...
<?php /**PATH E:\xampp\htdocs\atab\resources\views/auth/login.blade.php ENDPATH**/ ?>