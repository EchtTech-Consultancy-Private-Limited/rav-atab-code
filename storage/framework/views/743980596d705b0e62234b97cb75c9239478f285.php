...
<body class="light">
    ...
    <section class="content">
                            ...
                            <div class="body">
                                ...
                                <div class="row clearfix">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    ...
                                                    <label><?php echo e(date('d F Y', strtotime($ApplicationCourses->created_at->addYear()))); ?></label>
                                    ...
                                    <div class="col-sm-12 text-right">
                                       <div class="form-group">
                                          <div class="form-line">
                                             <a href="<?php echo e(url('/accr-view-document' . '/' .$ApplicationCourses->application_id.'/'.$ApplicationCourses->id)); ?>"
        ...
        <?php if(isset($ApplicationPayment)): ?>
...
<?php /**PATH /home/stagtbny/accr-rav.staggings.in/resources/views/application/accesser/Assessor_view.blade.php ENDPATH**/ ?>