              ...
              @endif
               ...
               <input type="hidden" name="application_id" value="{{ $item->application_list->id ?? '' }}">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                    <select name="assessor_type_{{ $assesorsData->id}}" id="assessor_type_{{ $assesorsData->id}}" class="d-block assessor_name_with_email" onchange="handleAssessorDesignation('assessor_type_{{ $assesorsData->id}}','{{ $item->application_list->id}}')">
