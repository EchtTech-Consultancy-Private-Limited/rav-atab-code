...
<body class="light">
    ...
    <section class="content">
                                                    ...
                                                    <tr class="document-row">
                                                        ...
                                                        <td>
                                                            ...
                                                            <td>
                                                                                ...
                                                                                <button
                                                                                class="expand-button btn btn-primary btn-sm"
                                                                                onclick="toggleDocumentDetails(this)">Show Comments</button>
                                                                                
                                                                                @if($doc->status!=0 && $doc->is_revert!=1)
                                                                                <button type="button" class="btn btn-primary btn-sm" onclick="handleRevertAction('{{ $doc->application_id }}', '{{ $doc->course_id }}', '{{ $doc->doc_file_name }}')">Revert</button>
       ...
       @elseif($application_details->application->approve_status==0 && $application_details->application->level_id==3)
                        ...
                        @if(!$is_final_summary_generated && $application_details->is_all_courses_rejected==false && !$is_onsite_assigned) 
                        <div class="col-md-12">
