                                    ...
                                    <a 
                                        ...
                                        @elseif($doc->onsite_status==4)
                                          <a 
                                             ...
                                             <a 
                                             title="{{$doc_}}"
                                             href="{{ url('super-admin-accept/admin/verify-doc'. '/' .  $doc->doc_sr_code .'/' . $doc_ . '/' . $application_id . '/' . $doc->doc_unique_id.'/'.$course_id) }}"
                                             class="btn btn-success btn-sm docBtn docBtn_nc  m-1">
                                             Accepted<span>By Admin</span></a>
                                             @endif
                                             ...
                                             <a 
                                             title="{{$doc_}}"
                                             href="{{ url('super-admin-reject/admin/verify-doc' . '/' . $doc->doc_sr_code .'/' . $doc_ . '/' . $application_id . '/' . $doc->doc_unique_id.'/'.$course_id) }}"
                                             class="btn btn-danger btn-sm docBtn docBtn_nc m-1">
                                             Rejected<span>By Admin</span></a>
                                             @endif
