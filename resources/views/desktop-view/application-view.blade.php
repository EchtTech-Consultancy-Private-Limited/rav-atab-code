                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class="form-line">
                                ...
                                <label>{{ $data->title ?? '' }}  {{ $data->firstname ?? '' }} {{ $data->middlename ?? '' }} {{ $data->lastname ?? '' }}</label>
                            </div>
                        </div>
                    </div>                 
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <div class="form-line">
                                            <label for="Declaration">Course Curriculum / Material / Syllabus</label>
                                            <span class="badge badge-success">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <span class="badge badge-success">
                <a href="{{url('doc').'/'.$ApplicationCourses->course_details_xsl}}" target="_blank" download title="Download Document">
                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach ($application_details->payment as $key=>$ApplicationPayment)
                                    <tr>
                                        ...
                                        ?>
                                            @if ($data == 'pdf')
                                                <a href="{{ asset('uploads/' . $ApplicationPayment->payment_proof) }}"
