                                                             ...
                                                             <tr>
                                                                 ...
                                                                 @foreach ($level_list_data as $item_level_list)
                                                                     @if (checktppaymentstatus($item_level_list->id) == 0)
                                                                         ...
                                                                         <td> <a href="{{ url('/level-first' . '/' . dEncrypt($item_level_list->id)) }}"
                                                     ...
                                                     @if ($item[0]->Fee_Structure_pdf != '')
                                                         ...
                                                         <a target="_blank"
                                                             ...
                                                             title="level Information pdf"><i
                                                                 class="fa fa-download mr-2"></i> PDF Fee Structure
                                                             pdf</a>
                             ...
                             <div class="modal-header">
                                 ...
                                 <div class="payment-status d-flex">
                                     ...
                                     <input type="text" name="Payment_Statuss" id="Payment_Statuss"
                                         ...
                                         style="border-bottom: 1px solid #fb483a !important;">
                                 </div>
                                                     ...
                                                     <div class="form-line">
                                                         ...
                                                         <div class="course_group">
                                                             <input type="number" placeholder="Years" name="years"
                                                                 required class="course_input" id="years">
                                                             <input type="number" placeholder="Months"
                                                                 name="months" required class="course_input"
                                                                 id="months">
                                                             <input type="number" placeholder="Days" name="days"
                                                                 required class="course_input" id="days">
                                                             <input type="number" placeholder="Hours"
                                                                 name="hours" required class="course_input"
                                                                 id="hours">
                                                         </div>
                                                 ...
                                                 <div class="form-group">
                                                     <div class="form-line">
                                                         ...
                                                         <a target="_blank" href="" id="docpdf1ss"
                                                             title=" Document 1"><i class="fa fa-download mr-2"></i>
                                                             PDF 1 </a>
                                                     ...
                                                     <div class="form-line">
                                                         ...
                                                         <a href="" id="docpdf3ss"
                                                             title="Download Document 1" download><i
                                                                 class="fa fa-download mr-2"></i> PDF 3 </a>
                                                     </div>
