                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="form-line">
                                                                            ...
                                                                            <input type="text" name="Person_Name"
                                                                                placeholder="Person Name" class="special_no" id="person_name"
                                                                                @isset($id)
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <div class="form-group">
                                                                        <div class="form-line">
                                                                            ...
                                                                            <input type="text"
                                                                                name="Contact_Number"
                                                                                placeholder="Contact Number" id="postal" minlength="10" maxlength="10"
                                                                                @isset($id)
                                             ...
                                             <tbody>
                                                 ...
                                                 <tr class="odd gradeX">
                                                     ...
                                                     <td class="center">
                                                         ...
                                                         <a href="" target="_blank" id="docpdf1" title="Download Document 1" download><i class="fa fa-download mr-2"></i> PDF 1
                                                         </a>
                                                     </td>
                                                 ...
                                                 <tr class="odd gradeX">
                                                     ...
                                                     <td class="center">
                                                         ...
                                                         <a href="" target="_blank" id="docpdf2" title="Download Document 2" download><i class="fa fa-download mr-2"></i> PDF 2
                                                         </a>
                                                 ...
                                                 <tr class="odd gradeX">
                                                     ...
                                                     <td class="center">
                                                         ...
                                                         <a href="" target="_blank" title="Download Document 3" id="docpdf3" download>
                                     ...
                                     <form action="" id="form_update" method="post">
                                         ...
                                         <div class="row mt-4">
                                             ...
                                             <div class="col-sm-3">
                                                 <div class="form-group">
                                                     <div class="form-line">
                                                         <label class="active">Eligibilitys<span> </label>
                                             ...
                                             <div class="col-sm-4">
                                                 <div class="form-group">
                                                     <div class="form-line">
                                                         <label>Course Details (Excel formate) <span class="text-danger">*</span></label>
                                                         <input type="file" name="doc3"
                                                             id="payment_reference_no"
                                                             class="form-control">
       ...
       $(document).on("click", "#view", function() {
           ...
           $.ajax({
               ...
               success: function(data) {
                   ...
                   $("a#docpdf1").attr("href", "{{ url('show-pdf') }}" + '/' + data.Document[0]
                       .document_file);
                   $("a#docpdf2").attr("href", "{{ url('show-pdf') }}" + '/' + data.Document[0]
                       .document_file);
                   $("a#docpdf3").attr("href", "{{ url('show-pdf') }}" + '/' + data.Document[0]
                       .document_file);
