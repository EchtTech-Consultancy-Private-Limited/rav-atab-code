                                ...
                                @endif
                                 ...
                                 <form action="{{ route('forget.password.post') }}" method="POST">
                                     ...
                                     <div class="form-group clearfix">
                                         ...
                                         <a href="http://localhost/Accr-Gireesh/accr_project/public" class="forgot-password float-end link-text">Back to Login</a>
                                     </div>
                                 </form>

                                 <p class="mb-0 mt-1 back-btn">Back to <a
                                         href="http://localhost/Accr-Gireesh/accr_project/public"
