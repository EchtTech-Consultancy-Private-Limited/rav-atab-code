        ...
        <form action="{{ url('/register') }}" method="post" class="form" id="regForm">
            ...
            <div class="form-item">
                ...
                <div class="iconInput_container">
                    ...
                    <div class="iconInput email">
                        ...
                        <input type="text" placeholder="Organization/Institute Name" class="special_no"
            ...
            <div class="form-item">
                ...
                <div class="iconInput_container">
                    ...
                    <div class="iconInput email">
                        <i class="fa fa-user" aria-hidden="true"></i>
                        <input type="text" placeholder="Middle Name" name="middlename" class="special_no"
                ...
                <div class="iconInput_container">
                    ...
                    <div class="iconInput email">
                        <i class="fa fa-user" aria-hidden="true"></i>
                        <input type="text" placeholder="Last Name" name="lastname" class="special_no"
                ...
                <div class="iconInput_container">
                    ...
                    <div class="iconInput email">
                        ...
                        <select name="designation" id="designation" class="select">
                            ...
                            <option value="Coordinator" {{ old('designation') == 'Coordinator' ? 'selected' : '' }}>
                                Coordinator</option>
                        </select>
                    </div>
                    {{-- <p class="error">This field is required</p> --}}
                ...
                <div class="iconInput_container">
                    <label for="gender" class="label_input"> <span>Gender<span class="text-danger">*</span></span>
                    </label>
                    <div class="iconInput">
                        ...
                        <div class="name">
                            ...
                            <label for="Other" class="sex label">
                                <input type="radio" id="Other" name="gender" value="Female" class="radio">
                                <span>Other</span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="iconInput_container">
                    ...
                    <div class="iconInput email">
                        ...
                        <input type="email" placeholder="Enter Email id" name="email" id="email"
                            value="{{ old('email') }}"
                            pattern="[a-z0-9\+_\-]+)(\.[a-z0-9\+_\-]+)*@([a-z0-9\10-]+\.)+[a-z]{2,6}$/ix']">
                ...
                <div class="iconInput_container">
                    ...
                    <div class="iconInput email">
                        <input type="text" class="input_otp" name="email_otp" id="email_otp"
                            value="{{ old('email_otp') }}" minlength="2" maxlength="6" id="mobile_no"
                ...
                <div class="iconInput_container">
                    ...
                    <div class="iconInput email">
                        <input type="number" class="input_otp" name="mobile_otp" value="{{ old('mobile_otp') }}"
                ...
                <div class="iconInput_container">
                    <label class="label_input"> Password<span class="text-danger">*</span>
                        ...
                        <span class="icon icon-t top-tip d-none">
                            <div class="tooltip l">
                                ...
                                <br>
                                <ol class="ctl00_ContentPlaceHolder1_BulletedList1 "
                                    style="list-style-type:decimal;margin-bottom:0px;">
                                ...
                                <br>
                                <b>Note:</b> Candidates are advised not to disclose or share their password with
                                anybody.
                            </div>
                    ...
                    <div class="iconInput email icon icon-t">
                        ...
                        <div class="tooltip ph">
                            ...
                            <b>Your password must satisfy the following:</b><br>
                            <br>
                            <ol class="ctl00_ContentPlaceHolder1_BulletedList1 mb-0"
                                style="list-style-type:decimal;margin-bottom:0px;">
                                <li>Password must be 8 to 15 character long.</li>
                                <li>Password must have at least one Upper case alphabet.</li>
                                <li>Password must have at least one Lower case alphabet.</li>
                ...
                <li class="iconInput email term-c">
                    <label class="check">
                        ...
                        <span>I Agree with Terms and Conditions<span class="text-danger">*</span>
                            ...
                            <button type="button" class="btn info-h tooltip-btn" data-toggle="tooltip"
                                data-placement="top" title="Click to terms and conditions box">
