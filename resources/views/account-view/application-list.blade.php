...
<body class="light">
    ...
    <section class="content">
        <div class="container-fluid">
                            ...
                            <table class="table table-responsive" style="width:100%;" id="dataTableMain-account">
                                ...
                                <tbody>
                                    ...
                                    <tr
                                        ...
                                        <td>
                                            <div>
                                                @if(isset($item->applicationDuration->applicationDayTime) && $item->applicationDuration->applicationDayTime !=0)
                                                <a class="btn btn-tbl-edit w-100 border-bottom border">          
                                                    {{$item->applicationDuration->applicationDayTime}} days Left
                                                </a>
                                                @endif
                                            </div>
                                        ...
                                        <hr>
                                        <div class="remaning-days d-flex">
                                            <div> <a href="{{ url('/account/application-view', dEncrypt ($item->application_list->id)) }}" class="btn btn-tbl-edit"><i class="material-icons">visibility</i></a>
                                            </div>
                                                <a class="btn btn-tbl-delete bg-history font-a" data-bs-toggle="modal"
                                                    data-bs-target="#view_history_{{$item->application_list->id}}">
                                                    History
                                                </a>
                                        </div>
                                        @elseif(isset($item->applicationDuration->applicationAction) && $item->applicationDuration->applicationAction =='V')
                                        <div class="remaning-days d-flex">
                                            <div> <a href="{{ url('/account/application-view', dEncrypt ($item->application_list->id)) }}" class="btn btn-tbl-edit"><i class="material-icons">visibility</i></a>
                                            </div>
                                                <a class="btn btn-tbl-delete bg-history font-a" data-bs-toggle="modal"
            ...
            <!-- Modal history -->
            <div class="modal fade" id="view_history_{{$item->application_list->id}}" tabindex="-1" role="dialog"
                                    ...
                                    <table class="table table-responsive-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span
                                                        class="badge badge-main {{$hist->status_color??''}}">{{$hist->status_text??''}}</span>
                                                </td>
