                            ...
                            <div class="p-l-20">
                                <ul class="nav ">
                                    <li class="nav-item tab-all p-l-20">
                                        <a class="nav-link {{request("type")=="other-world"?'active':''}}" href="{{url('internationl-page?type=other-world')}}">Rest of the World</a>
                                    </li>
                                    <li class="nav-item tab-all">
                                        <a class="nav-link  {{request("type")=="saarc"?'active':''}}" href="{{url('internationl-page?type=saarc')}}" >SAARC Countries</a>
                                    </li>
