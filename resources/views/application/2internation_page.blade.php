                                    ...
                                    <ul class="nav ">
                                        <li class="nav-item tab-all">
                                            <a class="nav-link active show" href="#level_information"
                                                data-bs-toggle="tab">SAARC Countries</a>
                                        </li>
                                        <li class="nav-item tab-all p-l-20">
                                            <a class="nav-link" href="#new_application" data-bs-toggle="tab">Rest of the
                                                World</a>
                                        </li>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach ($collection as $k => $item)
                                                                <tr class="odd gradeX">
                                                                    ...
                                                                    <td class="center">RAVAP-{{ 4000 + $item->user_id }}
                                                                    </td>
