                                                ...
                                                @foreach ($item->documents as $document)
                                                    ...
                                                    <td>
                                                        ...
                                                        @if (in_array($extension, ['xls', 'csv', 'pdf', 'xlsx']))
                                                            ...
                                                            @endif
                                                        @else
                                                            <label><i class="fa fa-info-circle mr-2"></i> Unsupported
                                                                File
                                                                Format</label>
                                                        @endif
                                                    </td>
                        ...
                        <div>
                            ...
                            <div>
                                <a href="{{ asset('documnet/' . $applicationDetails->gps_pic) }}" target="_blank">
                                    <img style="width: 200px; padding-top:10px; padding-bottom:20px;"
                                        src="{{ asset('documnet/' . $applicationDetails->gps_pic) }}" alt="">
                                </a>
                            </div>
                        </div>
                        <div>
