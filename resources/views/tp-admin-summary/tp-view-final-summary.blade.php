                                ...
                                <div class="p-3 bg-white">
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="fw-bold">Application No (provided by ATAB): <span class="fw-normal"> <input type="text" disabled value="RAVAP-{{$summeryReport->id}}"></span> </td>
                                ...
                                <div class="p-3  bg-white">
                                    ...
                                    <table >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="3" class="fw-bold">Application No (provided by ATAB):</br> <span class="fw-normal"> RAVAP-{{$onsiteSummaryReport->id}}</span>
                                                </td>
