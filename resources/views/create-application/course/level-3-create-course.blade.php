            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="card shadow-md">
                        ...
                        <form action="{{ url('/store-level-3-new-application-course') }}" enctype="multipart/form-data" method="post"
                            class="form">
                            @csrf
                            ...
                            @isset($course)
                             @if(count($course) < 1)
                            <a href="{{ url('create-level-3-new-applications/'.dEncrypt($applicationData?->id)) }}" class="btn btn-danger prev-step1">Previous</a>
                            @endif
                            @endisset
                    ...
                    @if(count($course)>0)
                            <div class="d-flex justify-content-end align-items-center">
                                <div>
                                    <a href="{{ url('create-level-2-new-applications/'.dEncrypt($applicationData?->id)) }}"
                                        class="btn btn-danger prev-step">Previous</a>
                                </div>
                                <div>
                                    @php
