                                                        ...
                                                        @foreach ($file as $k=> $files )
                                                            <tr class="odd gradeX">
                                                               ...
                                                               <td> <img src="{{ asset('documnet/'.$files->document_file) }}" width="150" height="120" /> </td>
                                                                ...
                                                                <tr class="@if(isset($doc_id1->doc_file)) highlight  @endif @if(get_doc_code($doc_id1->id)==__('arrayfile.document_doc_id_chap1')[1] && get_doccomment_status($doc_id1->id)==1) highlight_nc_approved @elseif(get_doc_code($doc_id1->id)==__('arrayfile.document_doc_id_chap1')[1] && get_doccomment_status($doc_id1->id)==0) highlight_nc @endif">
                                                                    <td>VMO.1</td>
                                                                ...
                                                                <tr class="@if(isset($doc_id2->doc_file)) highlight @endif @if(get_doc_code($doc_id2->id)==__('arrayfile.document_doc_id_chap1')[2] && get_doccomment_status($doc_id2->id)==1) highlight_nc_approved @elseif(get_doc_code($doc_id2->id)==__('arrayfile.document_doc_id_chap1')[2] && get_doccomment_status($doc_id2->id)==0) highlight_nc @endif">
                                                                    <td>VMO.2</td>
                                                                ...
                                                                <tr class="@if(isset($doc_id3->doc_file)) highlight  @endif @if(get_doc_code($doc_id3->id)==__('arrayfile.document_doc_id_chap1')[3] && get_doccomment_status($doc_id3->id)==1) highlight_nc_approved @elseif(get_doc_code($doc_id3->id)==__('arrayfile.document_doc_id_chap1')[3] && get_doccomment_status($doc_id3->id)==0) highlight_nc @endif">
                                                                    <td>VMO.3</td>
                                                                ...
                                                                <tr class="@if(isset($doc_id4->doc_file)) highlight  @endif @if(get_doc_code($doc_id4->id)==__('arrayfile.document_doc_id_chap1')[4] && get_doccomment_status($doc_id4->id)==1) highlight_nc_approved @elseif(get_doc_code($doc_id4->id)==__('arrayfile.document_doc_id_chap1')[4] && get_doccomment_status($doc_id4->id)==0) highlight_nc @endif">
                                                                    <td>VMO.4</td>
                                                                ...
                                                                <tr class="@if(isset($doc_id5->doc_file)) highlight  @endif @if(get_doc_code($doc_id5->id)==__('arrayfile.document_doc_id_chap1')[5] && get_doccomment_status($doc_id5->id)==1) highlight_nc_approved @elseif(get_doc_code($doc_id5->id)==__('arrayfile.document_doc_id_chap1')[5] && get_doccomment_status($doc_id5->id)==0) highlight_nc @endif">
                                                                    <td>VMO.5</td>
                                                                ...
                                                                <tr class="@if(isset($doc_id6->doc_file)) highlight  @endif @if(get_doc_code($doc_id6->id)==__('arrayfile.document_doc_id_chap1')[6] && get_doccomment_status($doc_id6->id)==1) highlight_nc_approved @elseif(get_doc_code($doc_id6->id)==__('arrayfile.document_doc_id_chap1')[6] && get_doccomment_status($doc_id6->id)==0) highlight_nc @endif">
                                                                    <td>VMO.6</td>
                                                                ...
                                                                <tr class="@if(isset($doc_id_chap2_2->doc_file)) highlight  @endif @if(get_doc_code($doc_id_chap2_2->id)==__('arrayfile.document_doc_id_chap2')[2] && get_doccomment_status($doc_id_chap2_2->id)==1) highlight_nc_approved @elseif(get_doc_code($doc_id_chap2_2->id)==__('arrayfile.document_doc_id_chap2')[2] && get_doccomment_status($doc_id_chap2_2->id)==0) highlight_nc @endif">
                                                                    <td>OGA.2</td>
                                                                    <td class="text-justify">
                                                                ...
                                                                <tr class="@if(isset($doc_id_chap2_3->doc_file)) highlight  @endif @if(get_doc_code($doc_id_chap2_3->id)==__('arrayfile.document_doc_id_chap2')[3] && get_doccomment_status($doc_id_chap2_3->id)==1) highlight_nc_approved @elseif(get_doc_code($doc_id_chap2_3->id)==__('arrayfile.document_doc_id_chap2')[3] && get_doccomment_status($doc_id_chap2_3->id)==0) highlight_nc @endif">
                                                                    <td>OGA.3</td>
                                                                    <td class="text-justify">
                                                                ...
                                                                <tr class="@if(isset($doc_id_chap2_4->doc_file)) highlight  @endif @if(get_doc_code($doc_id_chap2_4->id)==__('arrayfile.document_doc_id_chap2')[4] && get_doccomment_status($doc_id_chap2_4->id)==1) highlight_nc_approved @elseif(get_doc_code($doc_id_chap2_4->id)==__('arrayfile.document_doc_id_chap2')[4] && get_doccomment_status($doc_id_chap2_4->id)==0) highlight_nc @endif">
                                                                    <td>OGA.4</td>
                                                                    <td class="text-justify">
                                                                ...
                                                                <tr class="@if(isset($doc_id_chap2_6->doc_file)) highlight  @endif @if(get_doc_code($doc_id_chap2_6->id)==__('arrayfile.document_doc_id_chap2')[6] && get_doccomment_status($doc_id_chap2_6->id)==1) highlight_nc_approved @elseif(get_doc_code($doc_id_chap2_6->id)==__('arrayfile.document_doc_id_chap2')[6] && get_doccomment_status($doc_id_chap2_6->id)==0) highlight_nc @endif">
                                                                    <td>OGA.6</td>
                                                                    <td class="text-justify">
                                                                ...
                                                                <tr class="@if(isset($doc_id_chap3_1->doc_file)) highlight @endif  @if(get_doc_code($doc_id_chap3_1->id)==__('arrayfile.document_doc_id_chap3')[1] && get_doccomment_status($doc_id_chap3_1->id)==1) highlight_nc_approved @elseif(get_doc_code($doc_id_chap3_1->id)==__('arrayfile.document_doc_id_chap3')[1] && get_doccomment_status($doc_id_chap3_1->id)==0) highlight_nc @endif ">
                                                                    <td>FA.1</td>
                                                                    <td class="text-justify">
