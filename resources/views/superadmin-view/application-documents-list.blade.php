      ...
      <div class="container-fluid">
         <div class="block-header">
            <div class="row p-3">
               ...
               <div class="col-sm-6">
                  <div class="pr-2">
                     <a href="{{ url('/super-admin/application-view/'.dEncrypt($applicationData->id).'') }}" type="button" class="btn btn-primary "
                        ...
                        @if(in_array($question['question']->id,$course_doc_uploaded->pluck('doc_unique_id')->all())) 
                                    ...
                                    @if($doc->is_doc_show==0 && $doc->status==0)
                                       <a 
                                        ...
                                        href="{{ url('super-admin-view/desktop/verify-doc' . '/' . dEncrypt($doc->doc_sr_code) .'/' . $doc->doc_file_name . '/' . dEncrypt($application_id) . '/' . dEncrypt($doc->doc_unique_id).'/'.dEncrypt($course_id)) }}"
                                        class="btn btn-primary btn-sm docBtn m-1">
                                        View</a>
                                        @elseif($doc->status==1)
                                          <a 
                                             title="{{$doc->doc_file_name}}"
                                             href="{{ url('super-admin-accept/desktop/verify-doc' . '/' . dEncrypt($doc->doc_sr_code) .'/' . $doc->doc_file_name . '/' . dEncrypt($application_id) . '/' . dEncrypt($doc->doc_unique_id).'/'.dEncrypt($course_id)) }}"
                                             class="btn btn-success btn-sm docBtn docBtn_nc m-1">
                                             Accept <span>{{ucfirst($doc->assessor_type)}} Assessor</span></a>
                                    @elseif($doc->status==2)
                                    <a 
                                        title="{{$doc->doc_file_name}}"
                                        href="{{ url('super-admin-nc1/desktop/verify-doc' . '/' . dEncrypt($doc->doc_sr_code) .'/' . $doc->doc_file_name . '/' . dEncrypt($application_id) . '/' . dEncrypt($doc->doc_unique_id).'/'.dEncrypt($course_id)) }}"
                                        class="btn btn-danger btn-sm docBtn docBtn_nc m-1">
                                        NC1 <span>{{ucfirst($doc->assessor_type)}} Assessor</span></a>
                                        @elseif($doc->status==3)
                                          <a 
                                             title="{{$doc->doc_file_name}}"
                                             href="{{ url('super-admin-nc2/desktop/verify-doc' . '/' . dEncrypt($doc->doc_sr_code) .'/' . $doc->doc_file_name . '/' . dEncrypt($application_id) . '/' . dEncrypt($doc->doc_unique_id).'/'.dEncrypt($course_id)) }}"
                                             class="btn btn-danger btn-sm docBtn docBtn_nc m-1">
                                             NC2 <span>{{ucfirst($doc->assessor_type)}} Assessor</span></a>
                                             @elseif($doc->status==6)
                                          <a 
                                             title="{{$doc->doc_file_name}}"
                                             href="{{ url('super-admin-reject/desktop/verify-doc' . '/' . dEncrypt($doc->doc_sr_code) .'/' . $doc->doc_file_name . '/' . dEncrypt($application_id) . '/' . dEncrypt($doc->doc_unique_id).'/'.dEncrypt($course_id)) }}"
                                             class="btn btn-danger btn-sm docBtn docBtn_nc m-1">
                                             Reject <span>{{ucfirst($doc->assessor_type)}} Assessor</span></a>
                                        @elseif($doc->status==4)
                                          <a 
                                             title="{{$doc->doc_file_name}}"
                                             href="{{ url('super-admin-nr/desktop/verify-doc' . '/' . dEncrypt($doc->doc_sr_code) .'/' . $doc->doc_file_name . '/' . dEncrypt($application_id) . '/' . dEncrypt($doc->doc_unique_id).'/'.dEncrypt($course_id)) }}"
                                             class="btn btn-danger btn-sm docBtn docBtn_nc m-1">
                                             ...
                                             <a 
                                             title="{{$doc->doc_file_name}}"
                                             href="{{ url('super-admin-accept/admin/verify-doc'. '/' . $doc->status .'/'. dEncrypt($doc->doc_sr_code) .'/' . $doc->doc_file_name . '/' . dEncrypt($application_id) . '/' . dEncrypt($doc->doc_unique_id).'/'.dEncrypt($course_id)) }}"
                                             class="btn btn-success btn-sm docBtn docBtn_nc  m-1">
                                             Accepted</a>
                                             @endif
                                    ...
                                    @if($doc->is_doc_show==0 && $doc->onsite_status==0)
                                       <a 
                                        title="{{$doc->doc_file_name}}"
                                        href="{{ url('super-admin-view/onsite/verify-doc' . '/' . dEncrypt($doc->doc_sr_code) .'/' . $doc->doc_file_name . '/' . dEncrypt($application_id) . '/' . dEncrypt($doc->doc_unique_id).'/'.dEncrypt($course_id)) }}"
                                        class="btn btn-primary btn-sm docBtn m-1">
                                        View</a>
                                        @elseif($doc->onsite_status==1)
                                          <a 
                                             title="{{$doc->onsite_doc_file_name}}"
                                             href="{{ url('super-admin-accept/onsite/verify-doc' . '/' . dEncrypt($doc->doc_sr_code) .'/' . $doc->onsite_doc_file_name . '/' . dEncrypt($application_id) . '/' . dEncrypt($doc->doc_unique_id).'/'.dEncrypt($course_id)) }}"
                                             class="btn btn-success btn-sm docBtn docBtn_nc m-1">
                                             Accept <span>{{ucfirst($doc->assessor_type)}} Assessor</span></a>
                                    @elseif($doc->onsite_status==2)
                                    <a 
                                        title="{{$doc->onsite_doc_file_name}}"
                                        href="{{ url('super-admin-nc1/onsite/verify-doc' . '/' . dEncrypt($doc->doc_sr_code) .'/' . $doc->onsite_doc_file_name . '/' . dEncrypt($application_id) . '/' . dEncrypt($doc->doc_unique_id).'/'.dEncrypt($course_id)) }}"
                                        class="btn btn-danger btn-sm docBtn docBtn_nc m-1">
                                        NC1 <span>{{ucfirst($doc->assessor_type)}} Assessor</span></a>
                                        @elseif($doc->onsite_status==3)
                                          <a 
                                             title="{{$doc->onsite_doc_file_name}}"
                                             href="{{ url('super-admin-nc2/onsite/verify-doc' . '/' . dEncrypt($doc->doc_sr_code) .'/' . $doc->onsite_doc_file_name . '/' . dEncrypt($application_id) . '/' . dEncrypt($doc->doc_unique_id).'/'.dEncrypt($course_id)) }}"
                                             class="btn btn-danger btn-sm docBtn docBtn_nc m-1">
                                             NC2 <span>{{ucfirst($doc->assessor_type)}} Assessor</span></a>
                                             @elseif($doc->onsite_status==6)
                                          <a 
                                             title="{{$doc->onsite_doc_file_name}}"
                                             href="{{ url('super-admin-reject/onsite/verify-doc' . '/' . dEncrypt($doc->doc_sr_code) .'/' . $doc->onsite_doc_file_name . '/' . dEncrypt($application_id) . '/' . dEncrypt($doc->doc_unique_id).'/'.dEncrypt($course_id)) }}"
                                             class="btn btn-danger btn-sm docBtn docBtn_nc m-1">
                                             Needs Revision <span>{{ucfirst($doc->assessor_type)}} Assessor</span></a>
                                        @elseif($doc->onsite_status==4)
                                          <a 
                                             title="{{$doc->onsite_doc_file_name}}"
                                             href="{{ url('super-admin-nr/onsite/verify-doc' . '/' . dEncrypt($doc->doc_sr_code) .'/' . $doc->onsite_doc_file_name . '/' . dEncrypt($application_id) . '/' . dEncrypt($doc->doc_unique_id).'/'.dEncrypt($course_id)) }}"
                                             class="btn btn-danger btn-sm docBtn docBtn_nc m-1">
                                             Needs Revision <span>{{ucfirst($doc->assessor_type)}} Assessor</span></a>
                                             @if($doc->admin_nc_flag==1)
                                             <a 
                                             ...
                                             <a 
                                             title="{{$doc_}}"
                                             href="{{ url('super-admin-accept/'.$user_t.'/verify-doc'. '/' .  dEncrypt($doc->doc_sr_code) .'/' . $doc_ . '/' . dEncrypt($application_id) . '/' . dEncrypt($doc->doc_unique_id).'/'.dEncrypt($course_id)) }}"
                                             class="btn btn-success btn-sm docBtn docBtn_nc  m-1">
                                             Accepted<span>By Admin</span></a>
                                             @endif
                                             ...
                                             <a 
                                             title="{{$doc->doc_file_name}}"
                                             href="{{ url('super-admin-reject/'.$user_t.'/verify-doc' . '/' . dEncrypt($doc->doc_sr_code) .'/' . $doc->doc_file_name . '/' . dEncrypt($application_id) . '/' . dEncrypt($doc->doc_unique_id).'/'.dEncrypt($course_id)) }}"
                                             class="btn btn-danger btn-sm docBtn docBtn_nc m-1">
                                             Rejected<span>By Admin</span></a>
                                             @endif
